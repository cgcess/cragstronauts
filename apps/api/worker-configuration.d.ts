/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ee49bf9bd3b654889337bc6bfaf8c06)
...
interface __BaseEnv_Env {
	...
	ACCOUNT_INDEX: DurableObjectNamespace<import("./src/index").AccountIndexDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TripDO" | "TripIndexDO" | "AccountIndexDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "ADMIN_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
