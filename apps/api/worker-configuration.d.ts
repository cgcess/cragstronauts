/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 10b7dbb66034d27e2f14e48dfcaf2a80)
// Runtime types generated with workerd@1.20260515.1 2026-02-25 nodejs_compat
interface __BaseEnv_Env {
	...
	TRIP_DO: DurableObjectNamespace<import("./src/index").TripDO>;
	TRIP_INDEX: DurableObjectNamespace<import("./src/index").TripIndexDO>;
	ACCOUNT_DO: DurableObjectNamespace<import("./src/index").AccountDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TripDO" | "TripIndexDO" | "AccountDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "ADMIN_SECRET" | "CLERK_WEBHOOK_SIGNING_SECRET" | "DISCORD_WEBHOOK_URL">> {}
}
declare module "*.sql" {
	const value: string;
